  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md rounded-2xl border border-[var(--border)] bg-[var(--s1)] p-8 text-center space-y-4">
        ...
        <Link
          href="/app"
          className="h-10 px-4 text-body-sm font-semibold rounded-xl gradient-bg text-[#0B0B0C] hover:brightness-105 transition-[filter] inline-flex items-center gap-2 mx-auto w-fit"
        >
          Ir al resumen
