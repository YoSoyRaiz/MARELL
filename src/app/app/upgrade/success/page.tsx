...
export default async function UpgradeSuccessPage({
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4 max-w-md mx-auto">
      ...
      <p className="text-[14px] text-[var(--text2)] leading-relaxed mt-3">
      ...
      <Link
        href="/app"
        className="mt-6 h-11 px-6 gradient-bg text-[#0B0B0C] font-semibold text-[14px] rounded-xl glow-on-hover hover:brightness-105 inline-flex items-center gap-2 transition-[filter]"
      >
        Volver al resumen
